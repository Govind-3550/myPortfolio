  ...
  >
      <div className="sectionOneInfo flex flex-col gap-5  container m-auto px-5">
          ...
          <div className="sectionOneDownload ">
            ...
            <a  href="https://drive.google.com/uc?export=download&id=1Bx-v8MeC9HsAH6DUoUdGdu9o01IBojmo" className="flex items-center justify-center gap-1" download="Govind_Vishwakarma_resume.pdf" ><FaFileAlt />
            Download Resume </a>
