  ...
  >
      <div className="sectionOneInfo flex flex-col gap-5  container m-auto px-5">
          ...
          <div className="sectionOneDownload ">
            ...
            <a  href="./src/assets/Govind Bharat Vishwakarma_Resume(November_2024_Common).pdf" className="flex items-center justify-center gap-1" download="resume.pdf" ><FaFileAlt />
            Download Resume </a>
